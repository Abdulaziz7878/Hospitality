  ...
  const TeacherRow = ({ teacher }) => (
    <tr>
      ...
      <td
        ...
        onBlur={(e) =>
          updateTeacherData(teacher.id, "teacherId", e.target.textContent)
        }
      >
        {teacher.teacherId}
      </td>
      <td
        ...
        suppressContentEditableWarning
        onBlur={(e) =>
          updateTeacherData(teacher.id, "name", e.target.textContent)
        }
      >
        {teacher.name}
      </td>
      <td
        ...
        suppressContentEditableWarning
        onBlur={(e) =>
          updateTeacherData(teacher.id, "email", e.target.textContent)
        }
      >
        {teacher.email}
      </td>
      <td
        ...
        suppressContentEditableWarning
        onBlur={(e) =>
          updateTeacherData(teacher.id, "course", e.target.textContent)
        }
      >
        {teacher.course}
      </td>
